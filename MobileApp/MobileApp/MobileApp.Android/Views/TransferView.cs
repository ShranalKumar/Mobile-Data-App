...
namespace MobileApp.Droid.Views
{
    ...
    public class TransferView : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            _decimalPointVisibility = FindViewById<TextView>(Resource.Id.DataUnitDecimalText); _transferDialogDisplayText = FindViewById<TextView>(Resource.Id.TransferDialogText);
